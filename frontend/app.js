...
function render() {
  ...
  if (activeTab === 'stocks') renderStocks(snap, maxS);
  else if (activeTab === 'sectors') renderSectors(snap);
  else if (activeTab === 'sentiment') renderSentiment(snap);
  else if (activeTab === 'actions') renderActions(snap);
}
